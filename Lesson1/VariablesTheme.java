public class VariablesTheme  {
    public static void main(String[] args) {
        ...
        System.out.println("общуая стоимость товаров без скидки " + priceTotal);
        ...
        System.out.println("Код символа " + 124 + " Символ " + barVertical);
        ...
        System.out.println("    " + slashLeft  + slashRight);
        System.out.println("   " + slashLeft + "  " + slashRight);
        System.out.println("  " + slashLeft  + underscore  + parenthesisLeft + " " + parenthesisRight  + slashRight);
        System.out.println(" " + slashLeft + "      " + slashRight);
        System.out.println("" + slashLeft  + underscore   + underscore   + underscore  + underscore  + slashLeft  + slashRight + underscore + underscore  + slashRight + "\n");
